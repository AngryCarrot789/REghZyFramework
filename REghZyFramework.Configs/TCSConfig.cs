...
namespace REghZyFramework.Configs
{
    // stands for "TheR Config Structure"... lol. technically just a YAML parser 
    // but with less supported features (e.g. no lists within lists)

    /// <summary>
    ///     A basic class for loading/saving a TCS config file (which i made up lol). 
    ...
    /// </para>
    /// <para>
    /// This config doesnt support "ConfigurationSections", aka options within options, 
    /// or lists within lists. not yet atleast, its just a basic config
    /// </para>
    /// <para>
    ///     You can edit this config to your likings btw, but by default the config file is created in MyDocuments
    /// </para>
    /// made by REghZy/TheR/AngryCarrot789/Kettlesimulator/ThatThingCalledTheGalaxy/Carrot... all my different names lol
    /// </summary>
    public class TCSConfig
    {
        public const string DEFAULT_CONFIG_FILE_NAME = "config";
        public const string DEFAULT_CONFIG_DIRECTORY_NAME = "TheRWPFTemplateFull";
        ...
        /// <summary>
        /// Create an instance of the <see cref="TCSConfig"/> and load (or create) a config from the default 
